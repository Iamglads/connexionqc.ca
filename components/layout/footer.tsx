      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div
            ...
            className="relative"
          >
            {/* Effet de lueur - masqué sur mobile/tablette */}
            <div className="absolute -top-20 -left-20 w-64 h-64 bg-[#fac0d5]/20 rounded-full blur-3xl hidden lg:block" />
            <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#fac0d5]/20 rounded-full blur-3xl hidden lg:block" />
